...
export function Paragraph(props) {
  const objectPath = props.x;

  return (
    <div className={objectPath.class_Container}>
      <div className={objectPath.class_Container_Title}>
        <div className={objectPath.class_Title}>{objectPath.content_Title}</div>
      </div>
      <div className={objectPath.class_Container_Paragraph}>
        <div className={objectPath.class_Paragraph_1}>
          {objectPath.content_Paragraph_1}
        </div>
      </div>
      <div className={objectPath.class_Container_Paragraph}>
        <div className={objectPath.class_Paragraph_2}>
          {objectPath.content_Paragraph_2}
        </div>
      </div>
      <div className={objectPath.class_Container_Paragraph}>
        <div className={objectPath.class_Paragraph_3}>
          {objectPath.content_Paragraph_3}
        </div>
      </div>
    </div>
  );
