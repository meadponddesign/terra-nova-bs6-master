...
function Home() {
	return (
		<>
			{
				<HeaderImage
					src_background="sized_1903-taryn-elliott-3889765.jpg"
			...
			<div className="bg-dark ">
				{
					<Paragraph
						...
						content_Title="The Mystery, Majesty, & Flavors of North Africa" //////container
						//////Paragraph container
			...
			{<Slider classContainer='container mb-4 '
				...
				}
				{
					<Paragraph
						...
						class_Paragraph_1="p fw-light mt-4 mb-3 text-light"
						content_Paragraph_1=" Does the glut of travel information overwhelm you? 
                        Searching for the kind of vacation you want can be work rather than play. 
                        As a travel professional, I have years of experience navigating through the 
                        rough seas of our information age. Terra Nova's philosophy is if I do not know 
					...
					<div className="spacer"></div>
				{
					<ImageLeft
						...
						label_1="Lorem Ipsom"
						class_header_1=" h4 mt-0 mb-3 fw-light"
						...
						header_1="Morocco & North Africa Map Subhead"
