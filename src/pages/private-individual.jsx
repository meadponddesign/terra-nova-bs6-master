			...
			<div className="bg-dark ">
				{
					<Paragraph
						...
						content_Title="Blaze Your Own Path" //////container
						//////Paragraph container
						...
						content_Paragraph_1="Individual travel is you setting your own schedule, based upon your personal preferences and budget. The bulk of my trip designing caters to solo, couples, or a few friends deciding to head off and explore the world together. The nuts and bolts from airfare, accommodations, transportation, and sightseeing with private driver and guide can all be arranged."
						//////Paragraph 2
				...
				{<Slider classContainer='container mb-3 '
